								...
								<div class="blog-post style2 animate-onscroll">
									...
									<div class="post-image">
										...
										<?php if(isset($blog_item['video'])) echo base_url()."assets/".$blog_item['video']; ?>
									...
									<div class="post-content">
										...
										<div class="post-header">
											<h2><a href="<?php echo site_url('C_Main/beritaSingle')."/".$row->id; ?>"><?php if(isset($blog_item['title'])) echo $blog_item['title'];?></a></h2>
											<div class="post-meta">
										...
										<div class="post-exceprt">
											...
											<a href="<?php echo site_url('C_Main/beritaSingle')."/".$row->id; ?>" class="button read-more-button big button-arrow">Read More</a>
											<?php } ?>
