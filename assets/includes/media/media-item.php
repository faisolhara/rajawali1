							...
							<div class="media-item animate-onscroll <?php if($type == 'gallery') echo 'gallery-media'; ?>">
								...
								<img class="image" src="<?php if(isset($media['thumb'])) echo base_url()."assets/".$media['thumb']; ?>" alt="">
									...
									<div class="media-hover">
										...
										<p style="font-size:15pt;"><strong><?php echo $row->quote; ?></strong></p>	
											...
											<a target="_blank" href="<?php echo site_url()."assets/".$media['jackbox-link']; ?>" class="media-icon"><i class="icons icon-link"></i></a>
