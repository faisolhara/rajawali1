           ...
           <div class="page-content">
            <div class="page-subheading page-subheading-md">
                <ol class="breadcrumb">
                    ...
                    <li class="active"><a href="javascript:;">Produksi PG Krebet</a></li>
                </ol>
            </div>
            ...
            <div class="container-fluid-md">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h2 class="panel-title">Daftar Data Produksi PG Krebet</h2>
                            ...
                            <tbody align="center">
                                ...
                                <tr class="odd gradeX">
                                    ...
                                    <td>
                                        ...
                                        <div class="the-icon-hover col-lg-3 col-md-4 col-sm-6"><a href="hapusProduksiKrebet/<?php echo "$i->id_produksi"; ?>" onclick="return confirm('Anda yakin ingin menghapus data produksi ini?')"><i class="fa fa-eraser"></i>Hapus</a></div>
                                    </td>
                                </tr>
                                <?php } ?>
                            </tbody>
                ...
                <div class="modal-footer">
                    <div class="box box-danger">
                        <div class="box-body">
                            ...
                            <form  method="POST" action="<?php echo site_url('C_Admin/editProduksiKrebet/'.$row2->id_produksi); ?>">
